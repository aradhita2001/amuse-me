function getMeme(){
    ...
    imgTag.src = getRandom(memes);
    
    document.querySelector("#meme-content").appendChild(imgTag);
}

function getJoke() {
    clearAll();
    const pTag = document.createElement("p");
    pTag.innerHTML = getRandom(jokes);
    document.querySelector("#joke-content").appendChild(pTag);
}

function getQuote() {
    clearAll();
    const quoteTag = document.createElement("blockquote");
    const pTag = document.createElement("p");
    const citeTag = document.createElement("cite");

    const quote = getRandom(quotes);
    pTag.innerHTML = quote.quote;
    citeTag.innerHTML = "--" + quote.author;

    quoteTag.appendChild(pTag);
    quoteTag.appendChild(citeTag);
    document.querySelector("#quote-content").appendChild(quoteTag);
}

function getRiddle() {
    clearAll();

    const {question, answer} = getRandom(riddles);

    const riddleTag = document.createElement("p");
    const answerTag = document.createElement("p");

    riddleTag.innerHTML = question;
    answerTag.innerHTML = answer;

    document.querySelector("#riddle-content").appendChild(riddleTag);
    document.querySelector("#answer-content").appendChild(answerTag);
...
function getAnswer() {
    ...
    document.querySelector("#answer-content").style.visibility = "visible";
...
function clearAll() {
    ...
    answerContent.style.visibility = 'collapse';
}
